  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`relative z-10 px-4 sm:px-5 py-1.5 text-xs font-semibold transition-colors tap-safe ${currency === 'VES' ? 'text-black' : 'text-brand-200 hover:text-white/90'}`}
      >
        VES
      </button>
      <button
        ...
        className={`relative z-10 px-4 sm:px-5 py-1.5 text-xs font-semibold transition-colors tap-safe ${currency === 'USD' ? 'text-black' : 'text-brand-200 hover:text-white/90'}`}
      >
        USD
      </button>
    </div>
